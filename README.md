...
**Note:** This is a reconstructed version of the original work. The CAD files are not available; however, the MATLAB code(not uploaded yet) has been rebuilt based on the thesis documentation.
